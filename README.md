...
Use this method for easier management and configuration.

1. **Download the compose file:**
   ```bash
   curl -O https://raw.githubusercontent.com/saihgupr/HomeAssistantVersionControlBeta/main/docker-compose.yml
   ```

2. **Edit the configuration:**
   ```bash
   # Edit docker-compose.yml and update:
   # - Volume path: /path/to/your/ha/config
...
services:
  ha-version-control:
    image: ghcr.io/saihgupr/homeassistantversioncontrolbeta:latest
    container_name: ha-version-control
    ports:
      - "54001:54001"
    environment:
      - TZ=America/New_York
